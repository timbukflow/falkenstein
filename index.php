...
<body>
    ...
    <main class="main-container">
        ...
        <article class="column-four content-accordion">
            <section>
                <h3 class="nav accordionButton"><div class="line">&#x0007C;</div><span class="hover-nav">Respekt</span></h3>
                <p class="accordion-list"> Hallo ich bin ein Text</p>
            </section>
            <section>
                <h3 class="nav accordionButton"><div class="line">&#x0007C;</div><span class="hover-nav">Respekt</span></h3>
                <p class="accordion-list"> Hallo ich bin ein Text</p>
